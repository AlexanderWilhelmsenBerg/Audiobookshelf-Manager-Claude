# Phase 2 wave 5 — device test, build 0.5.0-one-timeline
...
3. Look at the notification's **second line**.
...
4. Lock the phone and look at the lock screen.

**Expect:** the same book-wide bar and times.

5. Scrub the notification's bar to roughly halfway.
...
**Expect:** under the book's seek bar and its two times, a **thinner second bar** in a different colour,
with `Chapter 4 of 32` on the left and a countdown like `−12:04` on the right.

2. Compare the two bars.
